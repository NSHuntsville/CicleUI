...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[SEDViewController alloc] initWithNibName:@"SEDViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[SEDViewController alloc] initWithNibName:@"SEDViewController_iPad" bundle:nil];
    }
